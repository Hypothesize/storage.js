...
interface JSONData { type: "json", body: Json }
...
interface MultiPartFormData { type: "multi", body: Obj<any> }
...
type BasicRequestData = EncodedUrlData | JSONData | RawData | StreamData | BufferData | FileData | TextData
type RequestData = BasicRequestData | MultiPartFormData | MultiPartRelatedData

function asQueryParams(obj: Obj<string>) {
    var str = [];
    for (var p in obj)
...
function getHttpData(data: RequestData): { "Content-Type"?: string, body: any } {
...
const getResponseHandler = (resolve: Function, reject: Function) => (
...
export async function postAsync(request: PostRequest) {
    return new Promise<Request.Response>((resolve, reject) => {
        let data = getHttpData(request.data)
        Request.post({
            uri: request.uri,
            body: data.body,
...
export async function getAsync(request: GetRequest) {
    return new Promise<Request.Response>((resolve, reject) => {
        let queryParams = request.query ? asQueryParams(request.query) : ""
        Request.get({
...
export function checkStatusCode(response: Request.Response, errMessage: string) {
