declare interface Repository<E extends keyof DTOsMap> extends RepositoryEditable<E> {
	deleteAsync: (id: string) => Promise<void>
}

declare interface RepositoryGroup<X = {}> {
...
declare interface RepositoryReadonly<E extends keyof DTOsMap> {
...
declare interface RepositoryEditable<E extends keyof DTOsMap> extends RepositoryReadonly<E> {
	saveAsync: (obj: ToStore<E>) => Promise<FromStore<E>>
}

declare interface IOProvider<X = {}> {
