...
export declare namespace Hypothesize {
    type Key = string | number | symbol;
    type Obj<TValue = any, TKey extends string = string> = {
        [key in TKey]: TValue;
    };
    type TypedObj<T> = {
    ...
    type ExtractByType<TObj, TType> = Pick<TObj, {
    ...
    type Promisify<T> = T extends string | number | undefined | null | Date ? Promise<T> : {
    ...
    namespace Entities {
        ...
        namespace Project {
            type Category = ("User" | "Recent" | "Popular" | "Shared");
            interface Base {
                name: string;
                description: string;
            }
        ...
        namespace Column {
            ...
            interface BusinessObject<TSummary extends Data.Summary.Base = Data.Summary.Base, TData = Primitive> extends Base, Omit<Hypothesize.Analysis.Variable, "columnName"> {
        ...
        namespace Analysis {
            ...
            namespace Kinds {
                ...
                interface Correlation extends Base {
                    ...
                    settings?: {
                        useControl: boolean;
                        measureLevels: Obj<Data.MeasureLevel>;
                    };
                }
                interface Regression extends Base {
                    ...
                    settings?: {
                        regressionGoal: "testHypothesis" | "maxAccuracy" | "maxInterpretability";
                        maxVariables: number;
                    };
                }
        ...
        namespace Result {
            ...
            interface ForStorage extends Group {
                id: string;
                analysisId: string;
                thumbnailSvg?: string;
            }
    ...
    namespace Data {
        ...
        interface NumberValue {
            original: any;
            effective: number;
            valueType: ValueType.integer | ValueType.float;
        }
        ...
        type Filter<T extends Obj<Primitive2> = Obj<Primitive2>> = (Filters.Categorical<T> | Filters.Ordinal<T> | Filters.Textual<T> | Filters.Statistical<T>);
         ...
         */
         | "repeated-integer-many-distincts" | "repeated-integer-few-distincts"
        /**
         * More than 90% of all NON-missing values are integers
         * AND number of unique values is more than 50% of number of total values
         */
         | "pure-integer" | "repeated-numeric" | "pure-numeric" | "repeated-date" | "pure-date" | "repeated-text" | "pure-text"
        /**
        ...
        namespace Summary {
            ...
            interface Nominal<T extends Primitive = Primitive> extends Base {
                mode: T;
            }
            interface Ordinal<T extends Primitive = Primitive> extends Nominal<T> {
                min: T;
                max: T;
                median: T;
                firstQuartile: T;
            ...
            interface Interval extends Ordinal<number> {
                mean: number;
                deviation: number;
                interQuartileRange: number;
            }
            type Any = Nominal | Ordinal | Interval;
        }
    ...
    namespace Analysis {
        ...
        type Goal = ("summary" | "factors" | "experiment" | "correlation" | "regression");
        ...
        namespace DataInfo {
            ...
            interface ActualColumns {
                data: {
                    ...
                    name?: string;
                    /** Actual data (used to create a stored table) */
                    columns: Obj<Data.ParsedValue["effective"][], string>;
                };
            }
            interface Table {
                tableId: string;
        ...
        type Core<TDataInfo extends DataInfo.Any = Analysis.DataInfo.Any> = Entities.Analysis.Base & {
            [key in "tableId" | "sourceData"]: key extends "tableId" ? string : ({
                name: string;
            } & {
                asColumns: Obj<any[]>;
            }) | {
    ...
    namespace Viz {
        ...
        interface Layer<A extends AxesType = AxesType, P extends Data.Cardinality = Data.Cardinality, S extends Data.Cardinality = Data.Cardinality> {
            color?: string;
            name: string;
            description?: string;
            ...
            mark: ({
                ...
                segmentSeparatorIcon?: Somatic.Renderer<any>;
            } | {
                type: "dots";
                icon?: Somatic.Renderer<any>;
            } | {
                type: "bars";
        ...
        type Axis<T extends Data.Cardinality> = {
            cardinality: T;
            label?: string;
            tickValues: Primitive<T>[];
            tickOptions?: {
                lines?: "default" | {
                    clip?: boolean;
                };
        ...
        type Generator<TSettings> = (columns: Array<{
            name: string;
            columnType: Data.ColumnType;
            measureLevels: Data.MeasureLevel[];
            vector: Data.ParsedValue[];
        }>, settings: TSettings) => Viz.Collection;
    }
    namespace Component {
        interface Theme {
            colors: {
        ...
        namespace Props {
            ...
            interface View<TData = {}> {
                ...
                itemTemplate?: Somatic.Renderer<{
                    datum: TData;
                    index: number;
                    style?: Somatic.CSSProperties;
                }>;
            }
        }
...
export declare namespace Somatic {
    ...
    interface CSSProperties {
        ...
        position?: "static" | "fixed" | "absolute" | "relative" | "sticky" | null;
        quotes?: string | null;
    ...
    type VNodeType<P = any> = Renderer<P> | string;
    ...
    type DOMFactory<Attr extends DOMAttributes<Elt>, Elt extends Element> = (props?: (ClassAttributes<Elt> & Attr) | null, ...children: VNode[]) => DOMElement<Attr, Elt>;
     ...
     */
    interface InternalPropsChangeMsg<P> extends Message {
        type: "internal-state-change";
        data: {
            delta: Hypothesize.RecursivePartial<P>;
        };
    }
