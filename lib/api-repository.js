...
class Repository extends repository_1.generate(class {
    ...
    findAsync(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const entityPluralName = new stdlib_1.String__(args.entity).plural();
    ...
    getAsync(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pluralParent = parentEntity !== "" ? new stdlib_1.String__(parentEntity).plural() : "";
            const effectiveParentId = parentEntity !== "" ? args.parentId : "";
            const pluralEntity = new stdlib_1.String__(args.entity).plural();
            const request = {
