...
function generate(ioProviderClass) {
    return class {
        constructor(config) {
            this.projects = this.createRepository("projects");
            this.tables = this.createRepository("tables");
            this.analyses = this.createRepository("analyses");
            this.columns = Object.assign(Object.assign({}, this.createRepository("columns")), { deleteAsync: undefined });
            this.results = Object.assign(Object.assign({}, this.createRepository("results")), { saveAsync: undefined, deleteAsync: undefined });
            try {
...
(function (Hypothesize) {
    ...
    (function (Analysis) {
        ...
        // settings?: Obj
    })(Analysis = Hypothesize.Analysis || (Hypothesize.Analysis = {}));
})(Hypothesize = exports.Hypothesize || (exports.Hypothesize = {}));
